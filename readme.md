...
**commit: `lesson_70: создал телеграм бота и подключил сигнал`**

### Добавление карточек в избранное

Модифицировали модель карточки


Добыли иконки на сайте https://icons.getbootstrap.com/
Для шаблона
<i class="bi bi-patch-plus"></i>
<i class="bi bi-patch-minus-fill"></i>

-- Черновик для функционала избранное
Осталось сделать вьюшки для добавления и удаления карточек из избранного
А так же асинхронные запросы JS для добавления и удаления карточек из избранного во всех нужных шаблонах (профиль, карточка, каталог)


**commit: `lesson_70: добавил иконки для избранного`**